...
public class AppCheckBox extends androidx.appcompat.widget.AppCompatCheckBox implements LanguageView {
    ...
    public AppCheckBox(Context paramContext, AttributeSet paramAttributeSet) {
        super(paramContext, paramAttributeSet);
        init(paramContext, paramAttributeSet);
    }

    public AppCheckBox(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
