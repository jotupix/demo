package com.jtkj.library.fastble.bluetooth;
...
import com.jtkj.library.fastble.data.BleConnectStateParameter;
import com.jtkj.library.fastble.data.BleDevice;
import com.jtkj.library.fastble.data.BleMsg;
import com.jtkj.library.fastble.exception.ConnectException;
import com.jtkj.library.fastble.exception.OtherException;
import com.jtkj.library.fastble.exception.TimeoutException;
    ...
    public synchronized BluetoothGatt connect(BleDevice bleDevice,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            bluetoothGatt = bleDevice.getDevice().connectGatt(BleManager.getInstance().getContext(),
                    autoConnect, coreGattCallback, TRANSPORT_AUTO);
        } else {
            bluetoothGatt = bleDevice.getDevice().connectGatt(BleManager.getInstance().getContext(),
