...
import com.jtkj.library.fastble.data.BleWriteState;
import com.jtkj.library.fastble.exception.GattException;
...
//        }
        ...
        if ((mCharacteristic.getProperties() & BluetoothGattCharacteristic.PROPERTY_WRITE_NO_RESPONSE) != 0) {
