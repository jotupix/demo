...
public class NetworkUtils {
	...
	/**
	 * returns the ConnectivityManager.TYPE_xxx if there's an active connection,
	 * otherwise returns TYPE_UNKNOWN
	 */
	...
	public static boolean isAirplaneModeOn(Context context) {
		// prior to JellyBean 4.2 this was Settings.System.AIRPLANE_MODE_ON,
		// JellyBean 4.2
