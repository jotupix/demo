package com.jtkj.library.fastble;
...
import com.jtkj.library.fastble.bluetooth.BleBluetooth;
import com.jtkj.library.fastble.bluetooth.MultipleBluetoothController;
import com.jtkj.library.fastble.bluetooth.SplitWriter;
import com.jtkj.library.fastble.callback.BleGattCallback;
import com.jtkj.library.fastble.callback.BleIndicateCallback;
import com.jtkj.library.fastble.callback.BleMtuChangedCallback;
import com.jtkj.library.fastble.callback.BleNotifyCallback;
import com.jtkj.library.fastble.callback.BleReadCallback;
import com.jtkj.library.fastble.callback.BleRssiCallback;
import com.jtkj.library.fastble.callback.BleScanAndConnectCallback;
...
public class BleManager {
    ...
    public boolean isConnecting(BleDevice bleDevice) {
        return getConnectState(bleDevice) == BluetoothProfile.STATE_CONNECTING;
    }

    public boolean isDisConnecting(BleDevice bleDevice) {
        return getConnectState(bleDevice) == BluetoothProfile.STATE_DISCONNECTING;
    }

    public boolean isDisConneced(BleDevice bleDevice) {
        return getConnectState(bleDevice) == BluetoothProfile.STATE_DISCONNECTED;
    }
